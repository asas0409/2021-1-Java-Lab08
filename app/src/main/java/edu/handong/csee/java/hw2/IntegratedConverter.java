...
/** 
* This is IntegratedConverter class that makes an instance of IntegratedConverter.
*/
public class IntegratedConverter {
    ...
    /** 
    *This is main method. It will create an instance of IntegratedConverter class and call run method.
    */
    ...
    /** 
    *This is run method. It will do actual conversion and show the result.
    */
